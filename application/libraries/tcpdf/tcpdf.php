...
class TCPDF {
	...
	public function Header() {
		$this->Cell(15);
		$this->Image(PDF_HEADER_LOGO,33,0,20);
		$this->SetFont('times','',12);
		// writeHTMLCell($w, $h, $x, $y, $html='', $border=0, $ln=0, $fill=0, $reseth=true, $align='', $autopadding=true)
        $this->WriteHTMLCell(0,0,'','',"<b><center>".DOC_TITLE."</center></b>",0,1,0,true,'C',true);
        $this->WriteHTMLCell(0,0,'15','19',"Government Polytechnic Mumbai",0,1,0,true,'L',true);
		
        $date=date_default_timezone_set('Asia/Kolkata');
        $this->SetFont('','',11);
		$this->WriteHTMLCell(0,0,'13','5',"ID: ". DOC_ID,0,1,0,true,'R',true);
