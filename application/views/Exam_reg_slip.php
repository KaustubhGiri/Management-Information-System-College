...
$table .='<tr>
            ...
            <th style="border:1px solid black" align="center">Course Type</th>
            <th style="border:1px solid black" align="center">Exam Status</th>
...
foreach($reg_data as $key => $value){
    foreach($value as $subkey => $subvalue){
        foreach($subvalue as $sub1key => $sub1value){
            if($sub1value->exam_reg_type=='7')
                $type="TH";
            elseif($sub1value->exam_reg_type=='5')
                $type="PR";
            elseif($sub1value->exam_reg_type=='6')
                $type="OR";
                $table .='<tr>
                                <td style="border:1px solid black" align="center">'.$sub1value->course_code.'</td> 
                                <td style="border:1px solid black" align="center">'.$sub1value->course_name.'</td>
                                <td style="border:1px solid black" align="center">'.$type.'</td>
...
ob_clean();
$pdf->Output('Exam registration slip.pdf', 'I');
