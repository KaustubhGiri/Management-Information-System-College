...
$(document).ready(function(){
			...
			$('#uni_upp_sel_tex_1').change(
			//choosing course on basis of scheme
			...
			$('#uni_upp_sel_tex_2').change(
				//choosing semester on basis of course
			function()
			{	
				var sc_id=$('#uni_upp_sel_tex_1').val();
                ...
                $('#uni_upp_sel_tex_3').append('<option value="'+value.semester_id+'">'+value.semester_number+'</option>');
					...
					$.ajax({
						...
						{	
							...
							$.each(data,function(key,value)
								        {
								        //  if'#uni_upp_sel_tex_5').append('<option value="'+value.dept_shift+'">'+value.scheme_year+'</option');   
...
<div class="wrapper">
		<div class="upper" id="upper">
			...
			<h4 class="titleofpage">Unit Test Marks Report</h4><br/>
